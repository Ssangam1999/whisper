    ...
    **decode_options,
    ...
    def decode_with_fallback(segment: torch.Tensor) -> DecodingResult:
        ...
        for t in temperatures:
            ...
            if t > 0:
                # disable bea_smize and patience when t > 0
...
#
# def cli(
#         audio_files=['/home/vertex/Documents/vertex_projects/whisper/CHASE.mp3'],
#         model_name="tiny",
#         model_dir='/home/vertex/Downloads/model',
#         device="cpu",
#         output_dir="output",
#         output_format="txt",
#         verbose=True,
...
# ):
#     # Default audio_files to record_audio if not passed
...
#
#     # Gather word options to check and pass them to the writer
#     word_options = {
...
#     }
#
#     # Check if word_timestamps is False and some word_options are set
#     if not word_timestamps:
#         for option, value in word_options.items():
#             if value:  # Check if the option is set to True
#                 raise ValueError(f"--{option} requires --word_timestamps True")
#
#     # Warn if max_line_count is set without max_line_width
#     if max_line_count and not max_line_width:
#         warnings.warn("--max_line_count has no effect without --max_line_width")
#
#     # Warn if max_words_per_line is set with max_line_width
...
#         try:
#             result = transcribe(model, audio_path, temperature=temperature)
...
def cli():
    ...
    parser.add_argument("--audio", nargs='+', default=['/home/vertex/Documents/vertex_projects/whisper/CHASE.mp3'], type=str, help="audio file(s) to transcribe")
